...
import me.weishu.kernelsu.ui.component.selectlkmdialog.SelectLkmDialogCoui
...
fun InstallScreen() {
    ...
    when (uiMode) {
        ...
        UiMode.Coui -> SelectLkmDialogCoui(
            show = showLkmDialog.value,
            currentVariant = lkmVariant,
            onDismissRequest = { showLkmDialog.value = false },
            onSelectVariant = actions.onSelectLkmVariant
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.Coui -> InstallScreenCoui(state, actions, couiSnackbarHost)
