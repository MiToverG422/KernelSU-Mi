...
import me.weishu.kernelsu.ui.component.coui.liquid.InnerShadow
import me.weishu.kernelsu.ui.component.coui.liquid.innerShadow
import me.weishu.kernelsu.ui.component.coui.liquid.lens
import me.weishu.kernelsu.ui.component.coui.liquid.rememberCombinedBackdrop
import me.weishu.kernelsu.ui.component.coui.liquid.vibrancy
import me.weishu.kernelsu.ui.component.coui.animation.DampedDragAnimation
import me.weishu.kernelsu.ui.component.coui.animation.InteractiveHighlight
...
val LocalFloatingBottomBarCouiTabScale = staticCompositionLocalOf { { 1f } }
...
@Composable
fun RowScope.FloatingBottomBarItemCoui(
    selected: Boolean,
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    content: @Composable ColumnScope.() -> Unit
) {
    val scale = LocalFloatingBottomBarCouiTabScale.current
    Column(
        modifier
    ...
    Box(
        ...
        if (isBlurEnabled) {
            CompositionLocalProvider(
                LocalFloatingBottomBarCouiTabScale provides {
