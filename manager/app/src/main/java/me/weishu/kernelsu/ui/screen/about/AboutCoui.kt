...
import me.weishu.kernelsu.ui.component.coui.effect.BgEffectBackground
import me.weishu.kernelsu.ui.component.coui.effect.ColorBlendToken
...
fun AboutScreenCoui(
    ...
    val barBlurBackdrop = rememberCouiBlurBackdrop(enableBlur)
    ...
    Scaffold(
        topBar = {
            CouiBlurredBar(backdrop = barBlurBackdrop, blurActive = blurActive) {
                SmallTopAppBar(
                    title = state.title,
